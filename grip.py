...
class TapeRecognitionCode:
    ...
    def __init__(self):
        ...
        self.__cv_resize_fx = 0.875
        self.__cv_resize_fy = 0.875
        ...
        self.__rgb_threshold_red = [61.91546762589926, 255.0]
        self.__rgb_threshold_green = [0.0, 255.0]
        self.__rgb_threshold_blue = [80.26079136690647, 255.0]
        ...
        self.__hsl_threshold_hue = [56.6546762589928, 160.3030303030303]
        self.__hsl_threshold_saturation = [149.05575539568343, 255.0]
        self.__hsl_threshold_luminance = [142.17625899280577, 250.7070707070707]
