...
class RetroReflectiveTapeDetector:
    ...
    def __init__(self):
        ...
        self.__hsl_threshold_luminance = [26.5592442126463, 239.97474747474746]
        ...
        self.__convex_hulls_0_contours = self.find_contours_output

        self.convex_hulls_0_output = None

        self.__filter_contours_contours = self.convex_hulls_0_output
    ...
    def process(self, source0, source1):
        ...
        # Step Convex_Hulls1:
        self.__convex_hulls_1_contours = source1
